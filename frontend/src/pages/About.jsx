  ...
  return (
    <>
      ...
      <Box sx={{ marginTop: "100px" }}>
        ...
        >
          <Button
            sx={{
              ...
              ":hover .MuiTypography-root ": { color: "#ffff" },
            }}
          >
            <Box
              sx={{
        ...
        <Stack sx={{ marginTop: "120px", marginBottom: "160px" }}>
          <img src="src\images\Frame 890.jpg" />
        </Stack>
        <Stack sx={{ marginBottom: "160px", marginX: "50px" }}>
          <img style={{ width: "100%" }} src="src\images\Frame 702.jpg" />
        </Stack>
      </Box>
    </>
  );
